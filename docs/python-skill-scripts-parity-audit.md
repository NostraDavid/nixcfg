...
Scope: all Python files under `dotfiles/agents/.agents/skill-sources` Method:
isolated black-box differential tests, normalized document comparison, and
injected network/subprocess adapters.
