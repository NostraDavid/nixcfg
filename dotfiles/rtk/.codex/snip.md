...
When executing shell commands, always prefix them with the snip proxy to reduce
token usage.
...
This applies to all shell commands. Snip filters verbose output while preserving
errors and essential information.
