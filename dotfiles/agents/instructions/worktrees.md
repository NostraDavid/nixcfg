...
Gebruik de skill `git-worktrees` via `~/.agents/skills/git-worktrees/SKILL.md`
wanneer de gebruiker een worktree vraagt of isolatie een concreet voordeel
heeft. Een extra worktree is niet vereist.
