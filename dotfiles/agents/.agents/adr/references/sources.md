...
- [npryce/adr-tools](https://github.com/npryce/adr-tools): inspiration for
  sequential naming and explicit relationships. Its commands and file schema are
  not assumed compatible with this skill's domain IDs.
...
existing repository tooling. Independent HTML would duplicate the contract. The
extra relationship fields make collection checks possible. Relative driver
