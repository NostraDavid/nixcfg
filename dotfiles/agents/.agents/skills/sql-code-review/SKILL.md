...
Perform a thorough SQL code review of the selected files, queries, or project scope (or entire project if no selection) focusing on security, performance, maintainability, and database best practices.
