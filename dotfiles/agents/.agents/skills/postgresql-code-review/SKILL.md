...
Expert PostgreSQL code review for the selected files, queries, or project scope (or entire project if no selection). Focus on PostgreSQL-specific best practices, anti-patterns, and quality standards that are unique to PostgreSQL.
