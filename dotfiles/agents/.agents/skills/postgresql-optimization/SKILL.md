...
Expert PostgreSQL guidance for the selected files, queries, or project scope (or entire project if no selection). Focus on PostgreSQL-specific features, optimization patterns, and advanced capabilities.
