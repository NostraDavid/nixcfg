...
2. **Download and place library file**:
   - Visit: [Excalidraw Libraries](https://libraries.excalidraw.com/)
...
1. Download desired Excalidraw libraries from [Excalidraw Libraries](https://libraries.excalidraw.com/)
...
- Examples found on [Excalidraw Libraries](https://libraries.excalidraw.com/) may include cloud/service icon sets.
