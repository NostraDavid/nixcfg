...
description: "Refactor given method `the target method` to reduce its cognitive complexity to `the agreed complexity threshold` or below, by extracting helper methods."
---
...
Refactor the method `the target method`, to reduce its cognitive complexity to `the agreed complexity threshold` or below, by extracting logic into focused helper methods.
...
- Have cognitive complexity reduced to the target threshold of `the agreed complexity threshold` or below
...
5. **Check cognitive complexity** - Confirm the metric is at or below the target threshold of `the agreed complexity threshold`
...
- [ ] Cognitive complexity is at or below the target threshold of `the agreed complexity threshold`
