...
Requires Python 3.8+ and Git. Run `scripts/scan.py` from the target project root. Accept an
optional focus area such as "architecture only" or "testing and concerns".
