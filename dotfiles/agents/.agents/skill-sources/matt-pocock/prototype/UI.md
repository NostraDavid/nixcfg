...
capture the prototype the way the [SKILL](SKILL.md) describes. Fold the winner
into the real code and move the rest onto the throwaway branch, not into main:
...
branch, not the bin — variant components and the switcher left in the main
