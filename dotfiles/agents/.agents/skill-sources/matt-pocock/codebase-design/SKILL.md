...
description: "Use when the user asks to design or improve a module interface, find deepening opportunities, choose test seams, or make module boundaries more testable or easier to navigate. Also use when another skill needs deep-module vocabulary; use software-architecture-design for system-level architecture choices."
---
