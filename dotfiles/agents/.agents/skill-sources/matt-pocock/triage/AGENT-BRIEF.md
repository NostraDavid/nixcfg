...
An agent brief is a structured comment or local issue section written when an
issue or change request moves to `ready-for-agent`. It is the authoritative
specification that an AFK agent will work from. The original body and discussion
