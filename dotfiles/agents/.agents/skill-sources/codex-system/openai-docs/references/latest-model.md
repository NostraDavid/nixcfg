...
This file is a curated helper. Every recommendation here must be verified
against current OpenAI docs before it is repeated to a user.
...
- This file will drift unless it is periodically re-verified against current
  OpenAI docs.
