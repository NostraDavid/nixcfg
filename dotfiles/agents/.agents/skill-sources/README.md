...
Onveranderde upstream- en importsnapshots staan afzonderlijk onder
[`../skill-originals`](../skill-originals/README.md). Daardoor blijven lokale
varianten actief en rechtstreeks bewerkbaar, terwijl hun baselines buiten de
clientdiscovery behouden blijven.
...
| `local`           | Lokaal geschreven of herontwerp |     18 | Individuele baselines in `local/SOURCE.md`                     |
| `polars-inc`      | `polars-inc/skills`             |      1 | Upstream `v0.2.0`                                              |
