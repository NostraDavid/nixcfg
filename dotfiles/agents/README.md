...
| [`local`](.agents/skill-sources/local/SOURCE.md)                     | 16     | Per skill of workflowfamilie vastgelegd in het bronbestand                                          |
...
- Codex gebruikt de ingebouwde skills uit `~/.codex/skills/.system`; de 55
  overige skills worden individueel gekoppeld onder `~/.codex/skills`.
- GitHub Copilot krijgt alle 60 skills als individuele koppelingen onder
  `~/.copilot/skills`.
